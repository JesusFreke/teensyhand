...
BEGIN {
    ...
    #The lower 6 bits hold the button index, while the MSB indicates if it was a press or release event
    #1 for press, 0 for release
    memory_variable "button_event_queue", 32;

    #The number of items currently in the button_events queue
    memory_variable "button_event_count", 1;
